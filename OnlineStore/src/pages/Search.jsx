...
const Search = () => {
  ...
  return (
    <div className="p-10 flex flex-col gap-8 md:px-24 lg:px-60 lg:pb-22">
      ...
      <hr className="border-b-4 w-full animate-hr border-blue-500 duration-700" />
      <div className="flex items-center gap-2 border-2 rounded-lg p-2 shadow-md">
        <input
          type="text"
          className="w-full px-4 outline-none"
          placeholder="Search by Title or Price (e.g., 100-500)"
          value={searchQuery}
          onChange={handleSearchByTitleAndPrice}
        />
        <Icon as={SearchIcon} boxSize={20} color="blue" />
      </div>
